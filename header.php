    	...
    	<div class="row mt-5 mb-5">
    		...
    		<div class="col col-sm-8">
    			<div class="dropdown">
                    ...
                    <input type="submit" name="searchrun1" id = 'searchrun1' value = "🔎Rechercher🔎" class="form-control form-control-lg" placeholder="Type Here..." id="search_box" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  />
					</form>
